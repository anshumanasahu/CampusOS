...
export default function Grainient({
  ...
  useEffect(() => {
    ...
    const program = new Program(gl, {
      ...
      uniforms: {
        ...
        uGrainAnimated: { value: 0.0 }, uContrast: { value: 1.5 }, uGamma: { value: 1.0 },
        uSaturation: { value: 1.0 }, uCenterOffset: { value: new Float32Array([0, 0]) },
    ...
    return () => { tryStop(); ro.disconnect(); io.disconnect(); document.removeEventListener('visibilitychange', onVis); ctxMap.delete(container); try { container.removeChild(canvas); } catch {} };
  }, []);
  ...
  useEffect(() => {
    ...
    u.uGrainAnimated.value = grainAnimated ? 1.0 : 0.0; u.uContrast.value = contrast;
    u.uGamma.value = gamma; u.uSaturation.value = saturation;
